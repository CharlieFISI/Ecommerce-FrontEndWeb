...
const SuccessScreen = () => {
  ...
  return (
    <View className="flex-1 bg-[#121212] justify-center items-center px-4">
      ...
      <Text className="mt-6 mb-2 text-2xl font-bold text-center text-white">Order Successful!</Text>
      ...
      >
        <Text className="text-lg font-semibold text-white">Continue Shopping</Text>
      </Pressable>
    </View>
  );
};
